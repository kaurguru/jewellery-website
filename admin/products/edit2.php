...
$sqli="INSERT INTO `silver-earrings` ( `discount`, `image`, `name`, `gender`, `category`, `price`, `qty`) VALUES ( '$discount','$image'  , '$name ' , '$gender ' , '$category ' , '$price  , '$quantity ')";
...
<a href="silver-earrings-form.php"><ion-icon name="chevron-back-outline" class="back"></ion-icon></a>
...
?> 
     <form action=" process.php " method="post" >
         ...
         <div>
             <input type="submit" value="edit product"  name="edit2"class="submit">
         </div>
