                        ...
                        <tbody>
                           ...
                           ?>
                            <tr>
                               ...
                               <td>
                                    <a href="edit.php?id=<?= $row["id"];?> "class="btn-edit"><ion-icon name="create" id="i" ></ion-icon></a>
                               </td>
                                <td>
                                    <!-- <form action="process.php" method="POST"> -->
                                    <!-- <input type="hidden" name= "id" value="> -->
                                    <button type ="button" class="remove-bg delete" name= "delete" value="<?php echo $row["id"];?>">  <ion-icon name= "trash" id="i"></ion-icon></button> 
                                    <!-- </form> -->
                                </td>
                            </tr>
                               <?php
