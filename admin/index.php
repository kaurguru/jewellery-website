                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-center">
                                                            ...
                                                            <h6 class="text-sm font-weight-normal mb-0 ">230,900
                                                            </h6>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-center">
                                                            <p class="text-xs font-weight-bold mb-0 ">Value:</p>
                                                            <h6 class="text-sm font-weight-normal mb-0 ">440,000
                                                            </h6>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle text-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-center">
                                                            <p class="text-xs font-weight-bold mb-0 ">Value:</p>
                                                            <h6 class="text-sm font-weight-normal mb-0 ">190,700
                                                            </h6>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle text-sm">
                                                ...
                                                <tr>
                                                    <td class="w-30">
                                                        <div class="d-flex px-2 py-1 align-items-center">
                                                            ...
                                                            <div class="ms-4">
                                                                ...
                                                                <h6 class="text-sm font-weight-normal mb-0 ">Brasil
                                                                </h6>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="text-center">
                                                            <p class="text-xs font-weight-bold mb-0 ">Value:</p>
                                                            <h6 class="text-sm font-weight-normal mb-0 ">143,960
                                                            </h6>
                                                        </div>
                                                    </td>
                                                    <td class="align-middle text-sm">
