          ...
          <form action="process.php" method="POST" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="gender" value="women" id="flexRadioDefault2"
                    checked>
                  <label class="form-check-label" for="">
                    Women
                  </label>
                ...
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="">Bigender</label>
                </div>
              </div>
              ...
              <div class="col-md-12">
                ...
                <button type="submit" class="btn btn-primary" name="add-products"> Save </button>
              </div>
            </div>
          </form>
        </div>
