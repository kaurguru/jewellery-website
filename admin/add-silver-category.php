          ...
          <form action="process.php" method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="number" name="discount"aria-label="Sizing example input" class="form-control" required placeholder="discount">
              </div>
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <div class="form-check">
                  <input class="form-check-input" type="radio" name="gender" value="women" name="flexRadioDefault" id="flexRadioDefault2" checked>
                  <label class="form-check-label" for="">
                  Women
                  </label>
                  
                  <div class="form-check">
                  <input class="form-check-input" type="radio" name="gender" value="All Gender" id="flexRadioDefault1">
                  <label class="form-check-label" for="">
                   All Genders
                  </label>
                </div>
              ...
              <div class="col-md-12">
                ...
                <button type="submit" class="btn btn-primary" name="add-silver-products"> Save </button>
              </div>
            </div>
          </form>
        </div>
