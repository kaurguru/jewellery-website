            ...
            <div class="sub-category">
                ...
                <div>
                    <a href="earrings.php?category=<?= $item['earring']; ?>"></a>
                        ...
                        <input type="checkbox" value="gold" checked name="search_value" ><label>Gold</label><br>
                        <input type="checkbox" value="silver"  name="search_value" disabled><label>Silver</label><br>
                        <input type="checkbox" value="artificial" name="searh_value" disabled><label>Artificial</label><br>
