...
<body>
    ...
    <form action="searchbar2.php" method="POST">
            ...
            <div class="sub-category">
                ...
                <div>
                    <a href="earrings.php?category=<?= $item['earring']; ?>"></a>
                        ...
                        <input type="checkbox" value="silver" checked name="search_value"><label>Silver</label><br>
                        <input type="checkbox" value="artificial"  disabled name="searh_value"><label>Artificial</label><br>
